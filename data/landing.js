...
export const featuresData = [
  {
    ...
    description:
      "Visualize trends and spending habits with intelligent dashboards.",
  },
  {
    icon: <Receipt className="h-8 w-8 text-blue-600" />,
    title: "AI Receipt Capture",
    description:
      "Snap a photo, and we’ll do the rest — fast and accurate parsing.",
  },
  {
    icon: <PieChart className="h-8 w-8 text-blue-600" />,
    title: "Goal-Based Budgeting",
    description:
      "Set goals and track progress with personalized budget suggestions.",
  },
  {
...
export const howItWorksData = [
  {
    ...
    description:
      "Join in seconds with a secure and seamless onboarding experience.",
  },
  {
    icon: <BarChart3 className="h-8 w-8 text-blue-600" />,
    title: "2. Sync Your Accounts",
    description:
      "Connect your bank, cards, and wallets to monitor all spending.",
  },
  {
    icon: <PieChart className="h-8 w-8 text-blue-600" />,
    title: "3. Unlock Insights",
    description:
      "Use AI to get real-time alerts and actionable financial advice.",
  },
];
